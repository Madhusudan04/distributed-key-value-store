...
public class ClusterConfig {
    ...
    public ConsistentHash consistentHash() {
        ...
        // Parse nodes from config: pod-1:localhost:9001,pod-2:localhost:9002,pod-3:localhost:9003
        ...
        log.info("ConsistentHash initialized with {} nodes and {} virtual nodes per node",
                 hash.getNodeCount(), virtualNodes);
        return hash;
    }
    ...
    public ReplicationManager replicationManager(
        ...
        return new ReplicationManager(consistentHash, cache);
    }
}